...
class TagController extends AbstractController
{
     ...
     */
    public function __construct(TagServiceInterface $tagService, TranslatorInterface $translator, Security $security)
    {
    ...
    {
        $tag = new Tag();
        $this->denyAccessUnlessGranted('CREATE', $tag);
    ...
    public function delete(Request $request, Tag $tag): Response
    {
        ...
        if (!$this->tagService->canBeDeleted($tag)) {
            $this->addFlash(
                'warning',
                $this->translator->trans('message.already_assigned')
            );
